...
export function DesktopNavigation() {
  return (
    <aside className="fixed left-0 top-0 z-30 hidden h-dvh w-64 shrink-0 flex-col border-r border-[#D6AD64]/10 bg-[linear-gradient(180deg,#050505_0%,#030303_58%,#070604_100%)] px-5 py-8 lg:flex xl:w-[17.5rem]">
      <LifeHQBrand className="mb-11 px-1" />

      <MainNavigation />

      <div className="mt-8 rounded-3xl border border-white/[0.08] bg-white/[0.02] p-4 text-sm leading-6 text-[#B8B1A7]">
      ...
      <div className="mt-auto pt-8">
        <NavLink
          to="/settings"
          className={({ isActive }) =>
            `flex min-h-12 items-center gap-3 rounded-2xl border px-3.5 py-3 text-sm font-medium transition-colors ${
              isActive
